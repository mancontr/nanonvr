...
import { Camera, CameraStatus, Event, TrackGroup } from 'src/types'
...
export const useCameraTracks = (id: string) => useFetch<TrackGroup[]>(id && (base + '/cameras/' + id + '/tracks'), null, 'tracks-' + id)
